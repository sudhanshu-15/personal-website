<template>
  <v-layout column justify-center align-center>
    <v-flex xs12 sm8 md6>
      ...
      <v-card>
        <v-card-media src="https://firebasestorage.googleapis.com/v0/b/personal-website-e3515.appspot.com/o/index_image.jpg?alt=media&token=0aa2cad7-a502-454c-8427-baa99c60cd83" height="400px"></v-card-media>
